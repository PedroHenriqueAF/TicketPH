...
form === null || form === void 0 ? void 0 : form.addEventListener('submit', (e) => {
    ...
    Object.entries(data).forEach(([key, value], index) => {
        if (!value) {
            const messageDragAndDrop = key === 'avatar' ? 'File too large. Pleace upload a photo under 500KB' : 'Upload your photo (JPG or PNG, max size: 500KB).';
...
function loadImage(file) {
    ...
    reader.onload = (e) => {
        var a, b;
        imgProfile.src = (a = e.target) === null || a === void 0 ? void 0 : a.result;
        avatarImage.value = (b = e.target) === null || b === void 0 ? void 0 : b.result;
